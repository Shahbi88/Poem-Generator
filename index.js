...
function generatePoem(event) {
  ...
  let context =
    "you're an expert in poetry with access to Arabic-to-English translated poems. Generate an eight-line poem about that. Below the poem, include who it is written by. Add -Written by: in a new line after the poem, use a line break. Do not fetch poems by anonymous authors.Display works by women poets more than men";
